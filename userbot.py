...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("log287")
                await self.one.join_chat("log287")
                await self.one.join_chat("log287")
            except:
                pass
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("log287")
                await self.two.join_chat("log287")
                await self.two.join_chat("log287")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("log287")
                await self.three.join_chat("log287")
                await self.three.join_chat("log287")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("log287")
                await self.four.join_chat("log287")
                await self.four.join_chat("log287")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("log287")
                await self.five.join_chat("log287")
                await self.five.join_chat("log287")
            except:
                pass
